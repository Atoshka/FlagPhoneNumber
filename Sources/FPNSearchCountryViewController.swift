...
public struct FPNSearchCountryViewControllerProps {
    ...
    var cancelButtonTextColor: UIColor = .white
    var statusBarStyle: UIStatusBarStyle = .lightContent
    var countryTextColor: UIColor = .black
    var countryCodeTextColor: UIColor = .gray
...
class FPNSearchCountryViewController: UITableViewController, UISearchResultsUpdating, UISearchControllerDelegate {
    ...
    var props: FPNSearchCountryViewControllerProps = .standard
    ...
    override func viewDidLoad() {
        ...
        tableView.backgroundColor = props.tableViewBackgroundColor
        tableView.separatorColor = props.tableViewSeparatorColor
    ...
    private func initSearchBarController() {
        ...
        if #available(iOS 9.0, *) {
            UITextField.appearance(whenContainedInInstancesOf: [UISearchBar.self]).defaultTextAttributes = [NSAttributedString.Key.foregroundColor: props.searchBarTextColor]
        } else {
            // Fallback on earlier versions
        }
        ...
        if let textfield = searchController?.searchBar.value(forKey: "searchField") as? UITextField {
            ...
            textfield.placeholder = props.searchPlaceholder
        }
        ...
        if #available(iOS 11.0, *) {
            ...
            let cancelButtonAttributes = [NSAttributedString.Key.foregroundColor: props.cancelButtonTextColor]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.textColor = props.countryTextColor
        cell.detailTextLabel?.text = country.phoneCode
        cell.detailTextLabel?.textColor = props.countryCodeTextColor
        cell.imageView?.image = country.flag
        cell.backgroundColor = props.cellBackgroundColor
